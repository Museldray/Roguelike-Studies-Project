...
public class RoomPrefabs
{
    public GameObject singleUp, singleDown, singleRight, singleLeft,
        doubleUpDown, doubleLeftRight, doubleUpRight, doubleUpLeft, doubleDownLeft, doubleDownRight, 
        tripleUpDownLeft, tripleUpDownRight, tripleLeftRightUp, tripleLeftRightDown,
        fourway;
}
...
public class LevelGenerator : MonoBehaviour
{
    ...
    void Update()
    {
        // This will only run in Unity editor
#if UNITY_EDITOR
